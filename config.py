...
class Config:
    ...
    SPECIES_ID_COLUMN = 'species'

    # Database setting  (for future integration)
    POSTGRES_URI = os.environ.get('PSTGRES_URI', 'postgresql://postgres:password@localhost:5432/treekipedia')
...
# Get configuration class bsed on environment
def get_config():
